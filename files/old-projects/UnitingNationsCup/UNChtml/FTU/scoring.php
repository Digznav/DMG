...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<aside>
				<div class="lang"><a href="es/scoring.php">Español</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#">English</a></div>
			...
			?>
			<div class="cont">
				<span class="title_section">Scoring</span>
				<nav class="scoreSubnav">
					<ul><li><a href="#diaTabla1" class="botsubMenu elementActive">4 Ball</a></li><li><a href="#diaTabla2" class="botsubMenu">Chapman</a></li><li><a href="#diaTabla3" class="botsubMenu">Single</a></li><li><a href="docs/2013_Uniting_Nations_Results-rnd3.pdf" target="_blank">PDF Version</a></li></ul>
				</nav>
				<div class="scoreTable">
					<div id="diaTabla1" class="panel">
						<table>
							<tr><td colspan="4"><span class="blueUSA">TEAM USA</span> <span class="red">VS</span> <span class="greenMEX">TEAM MÉXICO</span></td></tr>
							<tr><td><span class="blueUSA">Names</span></td><td><span class="blueUSA">4 Ball</span></td><td><span class="greenMEX">4 Ball</span></td><td><span class="greenMEX">Names</span></td></tr>
							...
							<tr><td><span class="medBlack">Totals</span></td><td><span class="blueUSA bigNumber">14 1/2</span></td><td><span class="greenMEX bigNumber">5 1/2</span></td><td><span class="medBlack">Totals</span></td></tr>
						</table>
					</div>
					<div id="diaTabla2" class="panel">
						<table>
							<tr><td colspan="4"><span class="blueUSA">TEAM USA</span> <span class="red">VS</span> <span class="greenMEX">TEAM MÉXICO</span></td></tr>
							<tr><td><span class="blueUSA">Names</span></td><td><span class="blueUSA">Chapman</span></td><td><span class="greenMEX">Chapman</span></td><td><span class="greenMEX">Names</span></td></tr>
							...
							<tr><td width="33%"><span class="blueUSA">Dunn, Alan</span></td><td rowspan="2"><span class="blueUSA bigNumber">1</span></td><td rowspan="2"><span class="greenMEX bigNumber"></span></td><td width="33%"><span class="greenMEX">Brugueiro, Saul</span></td></tr>
							<tr><td width="33%"><span class="blueUSA">Lane, Jay</span></td><td width="33%"><span class="greenMEX">Tominaga, Akira</span></td></tr>
							<tr><td><span class="medBlack">Totals</span></td><td><span class="blueUSA bigNumber">14</span></td><td><span class="greenMEX bigNumber">16</span></td><td><span class="medBlack">Totals</span></td></tr>
							<tr><td><span class="medBlack">Two‐day Totals</span></td><td><span class="blueUSA bigNumber">28 1/2</span></td><td><span class="greenMEX bigNumber">11 1/2</span></td><td><span class="medBlack">Two‐day Totals</span></td></tr>
						</table>
					</div>
					<div id="diaTabla3" class="panel">
						<table>
							<tr><td colspan="4"><span class="blueUSA">TEAM USA</span> <span class="red">VS</span> <span class="greenMEX">TEAM MÉXICO</span></td></tr>
							<tr><td><span class="blueUSA">Names</span></td><td><span class="blueUSA">Singles</span></td><td><span class="greenMEX">Singles</span></td><td><span class="greenMEX">Names</span></td></tr>
							...
							<tr><td><span class="medBlack">Totals</span></td><td><span class="blueUSA bigNumber">28</span></td><td><span class="greenMEX bigNumber">12</span></td><td><span class="medBlack">Totals</span></td></tr>

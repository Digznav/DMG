...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<nav class="nav">
				<a href="#">Inicio</a><a href="event.html">Evento</a><a href="teams.php">Equipos</a><!-- <a href="#">Patrocinadores</a> --><a href="gallery.html">Galería</a><a href="scoring.html">Puntuaciones</a><a href="news.html">Noticias</a><a href="arrive.html">Cómo llegar</a><a href="schedule.html">Calendario</a>
			</nav>
			...
			<div class="cont">
				...
				<div class="index_headquarters">
					...
					<a href="" target="_blank" class="hover_image"><img src="../imgs/mayan.jpg" alt="mayan"><span>Sede de la Uniting Nations Cup</span></a>
					<a href="" target="_blank" class="hover_image"><img src="../imgs/peninsula.jpg" alt="peninsula"><span>El campo</span></a>
				</div>
			</div>

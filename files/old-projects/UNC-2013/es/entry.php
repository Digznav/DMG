			...
			<div class="cont">
				...
				<section class="cont_sections cont_text">
					...
					<form name="uniting_form" id="uniting_form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" class="entry_form">
						...
						<div class="styleMe">
							<input type="number" name="eAge" id="eAge" placeholder="Edad">
						</div>
						<div class="styleMe">
							<input type="text" name="eClubName" id="eClubName" placeholder="Nombre del Club">
						</div>
						<div class="styleMe">
						...
						<div class="styleMe">
							<input type="number" name="eYears" id="eYears" placeholder="Años jugnado Golf">
						</div>
						<div class="styleMe">
							<textarea name="eAchiv" rows="7">Logros en el golf</textarea>
						</div>
						<div class="styleMe">
							<input type="text" name="eRegAssociation" id="eRegAssociation" placeholder="Número de afiliación de FMG:">
						</div>
						<div class="styleMe">
						...
						<div class="styleMe">
							<input type="number" name="ePhone" id="ePhone" placeholder="Número telefónico">
						</div>
						<div class="styleMe">

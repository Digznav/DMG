			...
			<div class="cont">
				...
				<section class="cont_sections cont_text">
					...
					<form name="uniting_form" id="uniting_form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" class="entry_form">
						...
						<div class="styleMe">
							<input type="number" name="eAge" id="eAge" placeholder="Age">
						</div>
						<div class="styleMe">
							<input type="text" name="eClubName" id="eClubName" placeholder="Club name">
						</div>
						<div class="styleMe">
						...
						<div class="styleMe">
							<input type="number" name="eYears" id="eYears" placeholder="Years playing Golf">
						</div>
						<div class="styleMe">
							<textarea name="eAchiv" rows="7">Achievements in golf</textarea>
						</div>
						<div class="styleMe">
							<input type="text" name="eRegAssociation" id="eRegAssociation" placeholder="State or Regional Golf Association">
						</div>
						<div class="styleMe">

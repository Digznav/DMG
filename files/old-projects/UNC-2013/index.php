...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<nav class="nav">
				<a href="#">Home</a><a href="event.html">Event</a><a href="teams.php">Teams</a><!-- <a href="#">Sponsors</a> --><a href="gallery.html">Gallery</a><a href="scoring.html">Score</a><a href="news.html">News</a><a href="arrive.html">How to arrive</a><a href="schedule.html">Schedule</a>
			</nav>
			...
			<div class="cont">
				<div class="index_teams">
					<span class="title_section">Teams - UNC 2012 players</span>
				...
				<div class="index_headquarters">
					...
					<a href="" target="_blank" class="hover_image"><img src="imgs/mayan.jpg" alt="mayan"><span>Host resort of the UNC</span></a>
					<a href="" target="_blank" class="hover_image"><img src="imgs/peninsula.jpg" alt="peninsula"><span>The course</span></a>
				</div>
			</div>

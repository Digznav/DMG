  ...
  <!-- Contenedor General a dos columnas -->
    ...
    <!-- Fila 1 Contenido -->
        ...
        <div class="pikachoose">
            ...
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag1.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag2.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag3.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag4.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag5.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag6.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag7.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag8.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag9.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag10.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag11.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag12.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag13.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag14.jpg"/></li>
            <li><img src="imgs/Actividades/recorridoCuetzalan/imag15.jpg"/></li>
          </ul>
        </div>
      </div>
    <!-- Fila 2 Contenido -->
    	<div id="contFila2">
      	<div id="tVerde"><a href="#">RECORRIDO HISTÓRICO, CULTURAL POR CUETZALAN</a></div>
        <div id="promTexto2">
        	<span class="tituloPormo">Recorrido: </span>
       	    <p>Descubre con nosotros este mágico lugar,  entérate de su historia, observa su arquitectura y vive de cerca sus  tradiciones con este recorrido vespertino por el centro de Cuetzalan.</p>
Algunos puntos de interés: la Parroquia de San Francisco, la iglesia de  nuestra señora de Guadalupe,  la iglesia  de la Conchita, la casa de cultura y el mercado de artesanías.
<hr />
          <span class="tituloPormo">Duración: </span>1 ½ horas<br />
<hr />
          <span class="tituloPormo">Costo: </span>$130.00 por persona.<br />
          <hr />

...
<body>
  ...
  <!-- Contenedor General a dos columnas -->
    ...
    <!-- Fila 1 Contenido -->
    	<div id="contFila1">
      	<div id="tRojo"><a href="#">QUIENES SOMOS</a></div>
        <div id="contenidoCrema">Somos una empresa social del municipio de Cuetzalan del Progreso Puebla, que se dedica a la venta de productos y servicios turísticos como un medio para el buen vivir de nuestras familias y comunidades.</div>
        <div class="pikachoose">
        	<ul id="pikame" class="jcarousel-skin-pika">
            <li><img src="imgs/mision/imag1.jpg"/></li>
            <li><img src="imgs/mision/imag2.jpg"/></li>
            <li><img src="imgs/mision/imag3.jpg"/></li>
            <li><img src="imgs/mision/imag4.jpg"/></li>
            <li><img src="imgs/mision/imag5.jpg"/></li>
            <li><img src="imgs/mision/imag6.jpg"/></li>
            <li><img src="imgs/mision/imag7.jpg"/></li>
            <li><img src="imgs/mision/imag8.jpg"/></li>
            <li><img src="imgs/mision/imag9.jpg"/></li>
            <li><img src="imgs/mision/imag10.jpg"/></li>
          </ul>
        </div>
      </div>
    </div>

...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Paquetes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Aventura <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Edición 
        </td>
    </tr>
    <tr>
...
if (isset($_SESSION['k_username'])) {
	...
	$xml = fopen ("../../../xml/paquetes/aventura/aventura".$aventura.".xml", "w");
	if (!$xml) {
	...
	if (fclose ($xml)){
		include("../../creamenu.php");
	   	echo 'Información del paquete Aventura '.$aventura.' Editada<BR><a href="index.php">Continuar</a><BR>';  
	}
	else
	{
		echo 'Error al escribir el XML particular de aventura<BR><a href="index.php">Continuar</a><br>';
	}

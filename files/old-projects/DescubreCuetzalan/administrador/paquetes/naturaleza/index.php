...
function valida_principal() {
	/*validar naturaleza*/
	if (document.principal.naturaleza.value == "0") {
		alert("Seleccione una sección válida");
		document.principal.naturaleza.focus();
		return 0;
	}
	/*termina validar naturaleza*/
...
if (isset($_SESSION['k_username'])) {
	if(isset($_POST['naturaleza']) && $_POST['seccion'] == "informacion"){
		/*estoy en seccion info general*/		
?>
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Paquetes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Naturaleza y Cultura <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información 
        </td>
    </tr>
    <tr>
...
<a href="index.php">Regresar</a>
		...
		<form action="creainfo.php" method="post" name="editainfo">
          ...
          <TR>
		    ...
		    </TABLE><input type="hidden" name="naturaleza" value="<?php echo $_POST['naturaleza'];?>"/>
    		<input type="button" onclick="valida_infor()" value="Editar" />
		</form>		
<?php
	}
	else if(isset($_POST['naturaleza']) && $_POST['seccion'] == "galeria"){
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Paquetes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Naturaleza y Cultura <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Selección
        </td>
    </tr>
    <tr>
    	<td class="titulo" colspan="2" valign="middle">IMÁGENES</td>
			...
			<FORM METHOD="POST" ACTION="creaimgs.php" enctype="multipart/form-data" name="losarchivos">
                ...
                <input name="naturaleza" type="hidden" value="<?php echo $naturaleza; ?>"/>
...
?>
	  					<tr>    
  							<td><img src="../../../imgs/Paquetes/naturaleza/<?php echo $naturaleza;?>/imag<?php echo $i;?>.jpg" width="120" height="100" />
                            </td>
        	    			<td>
...
<?php
			  				if($i<$elementos){?>
		  						<td><img src="../../../imgs/Paquetes/naturaleza/<?php echo $naturaleza;?>/imag<?php echo ($i+1);?>.jpg" width="120" height="100" />
                                </td>
          						<td>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Paquetes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Naturaleza y Cultura <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes
        </td>
    </tr>
    <tr>
    	<td class="titulo" colspan="2" valign="middle">IMÁGENES</td>
            ...
            <FORM METHOD="POST" ACTION="index.php" name="noimagenes">
                ...
                <input type="hidden" name="naturaleza" value="<?php echo $_POST['naturaleza'];?>"/>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Paquetes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Naturaleza y Cultura 
        </td>
    </tr>
    <tr>
    	<td class="titulo" colspan="2" valign="middle">PAQUETES - NATURALEZA Y CULTURA</td>
    </tr>
</table> 
                ...
                <tr>
                	<td align="center">
                        ...
                        <select name="naturaleza">
                            <option value="0">Seleccione</option>
                            <option value="1">NATURALEZA 1</option>
                            <option value="2">NATURALEZA 2</option>
                            <option value="3">NATURALEZA 3</option>
                            <option value="4">NATURALEZA 4</option>
                            <option value="5">NATURALEZA 5</option>
			            </select>
                	</td>            
            	</tr>
                <tr>

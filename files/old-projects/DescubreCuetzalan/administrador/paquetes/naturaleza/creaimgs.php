...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Paquetes <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Naturaleza y Cultura <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes  <img src="../../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Edición 
        </td>
    </tr>
    <tr>
...
if (isset($_SESSION['k_username'])) {
	...
	{
		$nombre_archivos[$i] = "../../../imgs/Paquetes/naturaleza/".$naturaleza."/imag".$i.".jpg";
	...
	for($i=1;$i<$elementos+1;$i++)
	{
		if (move_uploaded_file($_FILES['userfile'.$i]['tmp_name'],$nombre_archivos[$i])){
			$image->load('../../../imgs/Paquetes/naturaleza/'.$naturaleza.'/imag'.$i.'.jpg');
			$image->resize(716,305);
			$image->save('../../../imgs/Paquetes/naturaleza/'.$naturaleza.'/imag'.$i.'.jpg');

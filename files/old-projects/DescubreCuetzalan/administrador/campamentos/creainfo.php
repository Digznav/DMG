...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Posadas<img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Edición 
        </td>
    </tr>
    <tr>
...
if (isset($_SESSION['k_username'])) {
	...
	$caracteristicas = "";
	$xml = fopen ("../../xml/hospedaje/campamentos/campamento".$campamento.".xml", "w");
	if (!$xml) {
		echo "No se pudo abrir el archivo XML.";
		exit;
	}
	fwrite ($xml, '<?xml version="1.0" encoding="utf-8"?>');
	fwrite ($xml, '<campamento>');
	...
	if (fclose ($xml)){
		include("creamenu.php");
	   	echo 'La información de la campamento '.$campamento.' ha sido editada<BR><a href="index.php">Continuar</a><BR>';	   
	}
	else
	{

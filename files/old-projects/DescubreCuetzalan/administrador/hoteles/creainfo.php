...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Hoteles  <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Edición 
        </td>
    </tr>
    <tr>
...
if (isset($_SESSION['k_username'])) {
	...
	$caracteristicas = "";
	$xml = fopen ("../../xml/hospedaje/hoteles/hotel".$hotel.".xml", "w");
	if (!$xml) {
	...
	if (fclose ($xml)){
		include("creamenu.php");
	   	echo 'La información del Hotel '.$hotel.' ha sido editada<BR><a href="index.php">Continuar</a><BR>';	   
	}
	else
	{

...
function valida_principal() {
	/*validar hotel*/
	if (document.principal.hotel.value == "0") {
		alert("Seleccione un hotel válido");
		document.principal.hotel.focus();
		return 0;
	}
	/*termina validar hotel*/
...
if (isset($_SESSION['k_username'])) {
	if(isset($_POST['hotel']) && $_POST['seccion'] == "informacion"){
...
$url = "../../xml/hospedaje/hoteles/hotel".$hotel.".xml";  
$contenido_xml = "";  
if($d = fopen($url, "r"))
{  
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Hoteles <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información 
        </td>
    </tr>
    <tr>
...
<a href="index.php">Regresar</a>
            <FORM METHOD="POST" ACTION="index.php" name="noopciones">
                Inserte el número de opciones a mostrar del Hotel:
...
<?php
	...
	else if(isset($_POST['hotel']) && $_POST['seccion'] == "galeria"){
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Hoteles <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Selección
        </td>
    </tr>
    <tr>
...
<BR>
			...
			<FORM METHOD="POST" ACTION="creaimgs.php" enctype="multipart/form-data" name="losarchivos">
                ...
                <input name="hotel" type="hidden" value="<?php echo $hotel; ?>"/>
...
?>
	  					<tr>    
  							<td><img src="../../imgs/hospedaje/hoteles/hotel<?php echo $hotel;?>/imag<?php echo $i;?>.jpg" width="120" height="100" />
                            </td>
        	    			<td>
...
<?php
			  				if($i<$elementos){?>
		  						<td><img src="../../imgs/hospedaje/hoteles/hotel<?php echo $hotel;?>/imag<?php echo ($i+1);?>.jpg" width="120" height="100" />
                                </td>
          						<td>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td class="titulo" colspan="2" valign="middle">HOTELES</td>
    </tr>
</table> 

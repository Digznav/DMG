...
function valida_principal() {
	/*validar cabana*/
	if (document.principal.cabana.value == "0") {
		alert("Seleccione una cabaña válida");
		document.principal.cabana.focus();
		return 0;
	}
	/*termina validar cabana*/
...
if (isset($_SESSION['k_username'])) {
	if(isset($_POST['cabana']) && $_POST['seccion'] == "informacion"){
...
$url = "../../xml/hospedaje/cabanas/cabana".$cabana.".xml";  
$contenido_xml = "";  
if($d = fopen($url, "r"))
{  
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Cabañas <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información 
        </td>
    </tr>
    <tr>
...
<form action="creainfo.php" method="post" name="editainfo">
    		<TABLE width="600" border="0" cellpadding="0" align="center">
                <TR>
                    ...
                    <TD align="left"><input type="text" name="nombre" value="<?php echo $xml->nombre;?>" size="50" maxlength="30"/></TD>
                </TR>
                <TR>
          ...
          <TR>
            ...
            <input type="hidden" name="cabana" value="<?php echo $cabana;?>"/>
...
<a href="index.php">Regresar</a>
            <FORM METHOD="POST" ACTION="index.php" name="noopciones">
                Inserte el número de opciones a mostrar de la Cabaña:
                ...
                <input type="hidden" name="cabana" value="<?php echo $_POST['cabana'];?>"/>
...
<?php
	...
	else if(isset($_POST['cabana']) && $_POST['seccion'] == "galeria"){
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Cabañas <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Selección
        </td>
    </tr>
    <tr>
...
<BR>
			...
			<FORM METHOD="POST" ACTION="creaimgs.php" enctype="multipart/form-data" name="losarchivos">
                ...
                <input name="cabana" type="hidden" value="<?php echo $cabana; ?>"/>
...
?>
	  					<tr>    
  							<td><img src="../../imgs/hospedaje/cabanas/cabana<?php echo $cabana;?>/imag<?php echo $i;?>.jpg" width="120" height="100" />
                            </td>
        	    			<td>
...
<?php
			  				if($i<$elementos){?>
		  						<td><img src="../../imgs/hospedaje/cabanas/cabana<?php echo $cabana;?>/imag<?php echo ($i+1);?>.jpg" width="120" height="100" />
                                </td>
          						<td>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Cabañas <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes
        </td>
    </tr>
    <tr>
    	<td class="titulo" colspan="2" valign="middle">IMÁGENES</td>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td class="titulo" colspan="2" valign="middle">CABAÑAS</td>
    </tr>
</table> 

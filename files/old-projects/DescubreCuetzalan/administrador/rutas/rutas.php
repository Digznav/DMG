...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Rutas <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Información 
        </td>
    </tr>
    <tr>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Rutas <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Selección
        </td>
    </tr>
    <tr>
...
<a href="rutas.php">Regresar</a><BR>
...
?>
	  					<tr>    
  							<td><img src="../../imgs/Rutas/<?php echo $ruta;?>/imag<?php echo $i;?>.jpg" width="120" height="100" />
                            </td>
        	    			<td>
...
<?php
			  				if($i<$elementos){?>
		  						<td><img src="../../imgs/Rutas/<?php echo $ruta;?>/imag<?php echo ($i+1);?>.jpg" width="120" height="100" />
                                </td>
          						<td>
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="seccion" colspan="2" valign="middle">Rutas <img src="../../imgs/hover_sub.png" width="5" height="10" alt="pert" /> Imágenes
        </td>
    </tr>
    <tr>
    	<td class="titulo" colspan="2" valign="middle">IMÁGENES</td>
...
<a href="rutas.php">Regresar</a>
            <FORM METHOD="POST" ACTION="rutas.php" name="noimagenes">
...
<table width="750" border="0" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td class="titulo" colspan="2" valign="middle">RUTAS</td>
    </tr>
</table> 

<form name="principal" action="rutas.php" method="post">

...
if (isset($_SESSION['k_username'])) {
	...
	$xml = fopen ("../../xml/rutas/info/ruta".$ruta.".xml", "w");
	if (!$xml) {
	...
	if (fclose ($xml)){
		include("creamenu.php");
	   	echo 'Información de la Ruta '.$ruta.' Editada<BR><a href="rutas.php">Continuar</a><BR>';
	   
	}
	else
	{
		echo 'Error al escribir el XML<BR><a href="rutas.php">Continuar</a><br>';
	}

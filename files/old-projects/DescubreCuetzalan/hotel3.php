...
<!--lee xml -->
<?php
$url = "xml/hospedaje/hoteles/hotel3.xml";  
$contenido_xml = "";  
if($d = fopen($url, "r"))
{  
...
?>
  ...
  <!-- Contenedor General a dos columnas -->
    ...
    <!-- Fila 1 Contenido -->
    	<div id="contFila1">
      	<div id="tRojo"><a href="#">HOTELES</a></div>
        ...
        <div class="pikachoose">
			...
			?>
                <li><img src="imgs/hospedaje/hoteles/hotel3/imag<?php echo $r+1;?>.jpg"/></li>
			<?php
            }
			?>
          </ul>

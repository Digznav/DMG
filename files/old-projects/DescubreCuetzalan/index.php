    ...
    <!-- Columna 1 Index -->
      ...
      <!-- CLIMA -->
        ...
        <div id="clima" style="text-align:center;">
           ...
           <!-- www.TuTiempo.net - Ancho:225px - Alto:167px -->
<div id="TT_vBjE11E1EAdeEF1A1AqjjDzjDsaAMfCFbYkdEci5q1j"><a href="http://www.tutiempo.net">El Tiempo</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vBjE11E1EAdeEF1A1AqjjDzjDsaAMfCFbYkdEci5q1j"></script>
      ...
      <!-- PROMOCIONES -->
        <div id="promociones">
         ...
         <div id="socialFB"><section class="indexFB">
                        ...
                        <div id="socialSk"><script type="text/javascript" src="http://www.skypeassets.com/i/scom/js/skype-uri.js"></script>
<div id="SkypeButton_Call_descubrecuetzalan_1">
  <script type="text/javascript">
    Skype.ui({
      "name": "dropdown",
      "element": "SkypeButton_Call_descubrecuetzalan_1",
      "participants": ["descubrecuetzalan"],
      "imageSize": 24
    });
  </script>
</div>

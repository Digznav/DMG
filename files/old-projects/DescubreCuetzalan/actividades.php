...
$imagenes = DAOFactory::getImagenesDAO()->queryByIdRecorrido($_GET["id"]);
?>
  ...
  <!-- Contenedor General a dos columnas -->
    ...
    <!-- Fila 1 Contenido -->
        ...
        <div class="pikachoose">
            ...
            <?php
                            for ( $i=0; count( $imagenes ) > $i ; $i++ ) {
                                $reco = $imagenes[$i]; ?>
            <li><img src="<?php echo $reco->urlImagen; ?>"/></li>
              <?php }  ?>
          </ul>
        </div>
      </div>
    <!-- Fila 2 Contenido -->
    	<div id="contFila2">
    	<?php	$recorridos = DAOFactory::getRecorridoDAO()->load($_GET["id"]); ?>
      	<div id="tVerde"><a href="#"><?php echo $recorridos->nombre; ?></a></div>
        <div id="promTexto2">
        	<span class="tituloPormo">Recorrido:</span>
       	  <p><?php echo $recorridos->recorrido; ?></p>
       	  <hr />
          <span class="tituloPormo">Duración: </span><?php echo $recorridos->duracion; ?><br />
<hr />
          <span class="tituloPormo">Costo: </span><?php echo $recorridos->costo; ?><br />
          <hr />
          <span class="tituloPormo">Mínimo: </span><?php echo $recorridos->minimo; ?><br />
        </div>
      </div>
    </div>
	<!-- Pie de Pagina -->

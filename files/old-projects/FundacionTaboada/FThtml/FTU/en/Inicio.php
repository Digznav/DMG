...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="container">
			...
			<!-- Noticias -->
			<section class="news">
				<?php include "lib/News.php"; ?>
				<!-- <div class="loadingNews"></div>
				<div class="errorNews"><p><strong><span>W</span><br>Error al obtener las noticias.</strong></p></div> -->
			</section>
			<!-- Mini ayuda -->
					...
					<ul>
						...
						<li><a href="#">About the foundation</a>
							<ul>
								...
								<li><a href="Mision">Mission & Vision</a></li>
								<li><a href="Noticias">History News</a></li>
								<!-- li><a href="#">Our team</a></li -->
								<!-- li><a href="#">Board of Directors</a></li -->
							</ul>
						</li>
						<li><a href="Becas">Scholarship Program</a>
							<ul>
						...
						<li><a href="#">Events gallery</a>
							<ul>
								<li><a href="Fotografias">Photographs</a></li>
								<li><a href="Videos">Videos</a></li>
							</ul>
						</li>
						<li><a href="Ayuda">Do you want to help?</a></li>

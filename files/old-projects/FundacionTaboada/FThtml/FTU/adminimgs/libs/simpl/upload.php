...
return false;
		 ...
		 * @return bool
		 */
		public function UploadFile2($newfilename = ''){
			// Format the filename to make sure it is directory safe
			$this->FormatFilename();
			...
			return false;
				...
				/**	 * Upload File Form	 *	 * @return string	 */	public function Form($options='', $config=''){		return '<input name="" id="" type="" size="" maxlength="" value="" />';	}}?>
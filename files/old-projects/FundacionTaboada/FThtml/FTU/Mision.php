...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="container">
			<!-- Contenido -->
			<div class="content">
				<span class="pageLocation">Acerca de la fundación / <span class="actualPage">Misión & Visión</span></span><br>
				<span class="title">Misión y Visión</span>
				<div class="cont imageTextFormat">
					<img src="imgs/mision.jpg" alt="Mision Vision">
					<p><span class="subtitle">Misión</span><br>Otorgar becas a nivel licenciatura en Universidades privadas de conocido prestigio a jóvenes mexicanos con excelencia académica y cuyos padres no tengan los recursos económicos para solventar el costo de las colegiaturas y también otorgar becas a nivel técnico para que los jóvenes de muy escasos recursos económicos tengan una capacitación que les asegure su inserción al mercado laborar.</p>
					<p><span class="subtitle">Visión</span><br>Mantenernos y actualizarnos constantemente como una institución de Beneficencia Privada que impulsa la Educación de Excelencia para lograr un México con valores, con cultura y Responsabilidad Social, de modo que las futuras generaciones estén capacitadas para afrontar los retos del mundo global actual.</p>
				</div>
				<hr>
				<!-- Eventos -->

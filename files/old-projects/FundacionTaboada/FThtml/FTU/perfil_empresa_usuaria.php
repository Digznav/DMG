                            ...
                            <table width="680px" align="center" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td width="340px"  valign="top" style="padding-left:10px;" align="left">
                                         Perfil de Empresa Usuaria del Transporte de Carga
                                        <input type="hidden" name="perfil" value="1" id="perfil"  />  
                                    </td>        
                                </tr>                                
								...
								<tr>
									<td  valign="middle" style="padding-right:5px;" class="normal3" align="right">
										<select multiple name="sucursales[]" size="10" id="sucursales" style="width:250px;"  >
								...
								<tr>
									<td  valign="top" style="padding-right:5px;" class="normal3" align="right">
										Estados en donde env&iacute;a sus productos
									</td>
									<td  valign="middle" style="padding-left:10px;" align="left">
								...
								<tr>
									<td  valign="middle" style="padding-right:5px;" class="normal3" align="right">
										Tipo de Mercanc&iacute;a
									</td>
									<td  valign="middle" style="padding-left:10px;" align="left">
										<input type="text" name="tipoMercancia" id="tipoMercancia" size="40" maxlength="240" value="" required />
									</td>        
								</tr>
								...
								<tr>
									<td  valign="top" style="padding-right:5px;" class="normal3" align="right">
										Tipo de unidad solicitadas por las plantas 
									</td>
									<td  valign="middle" style="padding-left:10px;" align="left">

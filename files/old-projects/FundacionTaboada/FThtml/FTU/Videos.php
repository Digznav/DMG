...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<header>
			<div>
				...
				<nav class="mainNav clear">
					<ul><li><a href="Inicio">Inicio</a></li><li><a href="#">Acerca de la fundación</a><ul><li><a href="Historia">Historia</a></li><li><a href="Mision">Misión & Visión</a></li><li><a href="Noticias">Historial de Noticias</a></li><!-- li><a href="#">Nuestro equipo</a></li --><!-- li><a href="#">Junta Directiva</a></li --></ul></li><li><a href="Becas">Programa de becas</a><ul><li><a href="Preguntas">Preguntas frecuentes</a></li></ul></li><li><a href="Contacto" class="activeNav">Galería de eventos</a><ul><li><a href="Fotografias">Fotografías</a></li><li><a href="Videos">Videos</a></li></ul></li><li><a href="Ayuda">¿Deseas ayudar?</a></li><li><a href="Contacto">Contacto</a></li></ul>
				</nav>
			</div>
		</header>
		...
		<div class="container">
			<!-- Contenido -->
			<div class="content">
				<span class="pageLocation">Galería de eventos / <span class="actualPage">Videos</span></span><br>
				<span class="title">Galería de videos</span>
				<div class="cont"><iframe class="vid" src="//www.youtube.com/embed/Nz7zkr4j808" frameborder="0" allowfullscreen></iframe></div>
				<hr>
				<!-- Eventos -->

	...
	<body>
		<div id="container">
			...
			<div class="cont onlyText clearfix">
				...
				<h2 class="sectionTitle"><?php echo $actividad->nombre; ?> - Edición</h2>
				<p>Seleccione la opción que desee modificar</p>
				<ul class="edit-Options">
					<li><a href="editar.php?id=<?php echo $idActividad; ?>&action=modGeneral">Datos generales</a></li>
					<li><a href="editar.php?id=<?php echo $idActividad; ?>&action=modHD">Imagen de fondo</a></li>
					<li><a href="editar.php?id=<?php echo $idActividad; ?>&action=modServ">Servicios generales</a></li>
					<li><a href="editar.php?id=<?php echo $idActividad; ?>&action=modGallery">Galería de imágenes</a></li>
				</ul>

<?php
$count = 1;
$serviciosGenerales = DAOFactory::getServiciosActivDAO()->queryByIdActiv( $idActividad );
		...
		<tbody id="ObjectsList">
			...
			<tr class="obj-li" data-num-obj="<?php echo $count; ?>">
				<td>
					...
					<input type="hidden" name="servicios[serv<?php echo $count; ?>][idActiv]" value="<?php echo $value->idActiv; ?>">
				</td>

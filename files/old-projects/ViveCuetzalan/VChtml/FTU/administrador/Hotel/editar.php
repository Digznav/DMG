	...
	<body>
		<div id="container">
			...
			<div class="cont onlyText clearfix">
				...
				elseif ( isset($_GET['action']) && $_GET['action']=='modHab' ) {
					include('libs/editar-Habitaciones.php');
				}
				...
				<h2 class="sectionTitle"><?php echo $hotel->nombre; ?> - Edición</h2>
				<p>Seleccione la opción que desee modificar</p>
				<ul class="edit-Options">
					<li><a href="editar.php?id=<?php echo $idHotel; ?>&action=modGeneral">Datos generales</a></li>
					<li><a href="editar.php?id=<?php echo $idHotel; ?>&action=modHD">Imagen de fondo</a></li>
					<li><a href="editar.php?id=<?php echo $idHotel; ?>&action=modHab">Habitaciones</a></li>
					<li><a href="editar.php?id=<?php echo $idHotel; ?>&action=modServ">Servicios generales</a></li>
					<li><a href="editar.php?id=<?php echo $idHotel; ?>&action=modGallery">Galería de imágenes</a></li>
				</ul>

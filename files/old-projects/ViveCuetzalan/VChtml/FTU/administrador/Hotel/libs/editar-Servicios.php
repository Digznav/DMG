<?php
$count = 1;
$serviciosGenerales = DAOFactory::getServiciosHotelDAO()->queryByIdHotel( $idHotel );
		...
		<tbody id="ObjectsList">
			...
			<tr class="obj-li" data-num-obj="<?php echo $count; ?>">
				<td>
					...
					<input type="hidden" name="servicios[serv<?php echo $count; ?>][idHotel]" value="<?php echo $value->idHotel; ?>">
				</td>

...
if( !empty($_POST) && !empty($_FILES) ) {
	...
	if ($_FILES['logo']['name'] != "" ){
		$folderName = clean($hotel->nombre);
		$fileName = 'logo'.$hotel->id.'-'.rand(1,99);
	...
	//echo '<script type="text/javascript">window.location.replace("paso2.php?id='.$hotel->id.'&fd='.$folderName.'");</script>';
	header('Location: paso2.php?id='.$hotel->id.'&fd='.$folderName );
	die();
} ?>
<!DOCTYPE html>
	...
	<body>
		<div id="container">
			...
			<div class="cont onlyText clearfix">
				<h2 class="sectionTitle">Añadir hotel - Datos generales</h2>
					...
					<table class="tableFormat">
						<tbody>
							...
							<tr>
								...
								<td><input type="number" name="habitaciones" id="habitaciones"></td>
							</tr>
							<tr>

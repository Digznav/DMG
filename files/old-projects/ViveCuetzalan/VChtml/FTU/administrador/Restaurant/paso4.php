...
if( !empty($_POST) && !empty($_FILES) ) {
	...
	foreach ($_FILES['imagenes']['name'] as $f => $name) {
		$fileName = 'img'.$idRestaurant.'-'.$count;
	...
	<body>
		<div id="container">
			...
			<div class="cont onlyText clearfix">
				<h2 class="sectionTitle">Añadir restaurant - Imágenes de galería</h2>
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<a <?php echo 'href="borrar.php?id='.$idRestaurant.'&del1=true&del2=true"'; ?> class="isButton symb-icon icoClosefill" onclick="return confirm('Se eliminarán los datos creados hasta el momento. ¿Desea cancelar de todos modos?')">Cancelar</a>

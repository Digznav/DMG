...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<div id="container">
			<?php $urlEsp = "../Contacto"; $actMenu = 'Contacto'; include("libs/header.php");
			...
			<div class="cont onlyText clearfix">
				...
				<div class="scrollCont">
					<p>Do not hesitate to contact us, fill the form and choose one or more services that you find interesting.</p>
				</div>
			</div>

...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<div id="container">
			<?php $urlEng = "../en/mobile/Where_to_eat"; $actMenu = 'Donde_comer'; include("libs/header.php");
			...
			<div class="cont onlyText clearfix">
				<h2 class="sectionTitle">Dónde comer en Cuetzalan</h2>
				<ul id="logosGrid">
					<?php
					foreach ($resultcomida as $key) { echo '<li><a href="Comida?id='.$key[0].'"><img src="../'.$key[4].'"><p>'.$key[1].'</p></a></li>';}
					?>
				</ul>
			</div>

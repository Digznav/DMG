...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<div id="container">
			<?php $urlEng = "../en/mobile/Contact"; $actMenu = 'Contacto'; include("libs/header.php"); ?>
			<div class="cont onlyText clearfix">
				<h2 class="sectionTitle">Contáctanos</h2>
				<p>Le invitamos a ponerse en contacto con nosotros, solo llene los espacios correspondientes completos y elija a uno o más prestadores de servicio que le sean de interés.</p>
			</div>

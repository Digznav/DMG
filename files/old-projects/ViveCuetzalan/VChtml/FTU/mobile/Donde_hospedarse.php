...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<div id="container">
			<?php $urlEng = "../en/mobile/Where_to_stay"; $actMenu = 'Donde_hospedarse'; include("libs/header.php");
			require_once('../libs/consulta_hotel.php'); ?>
			<div class="cont onlyText clearfix">
				<h2 class="sectionTitle">Dónde hospedarse en Cuetzalan</h2>
				<ul id="logosGrid">
					<?php foreach ($resulthotel as $key) { echo '<li><a href="Hotel?id='.$key[0].'"><img src="../'.$key[4].'"><p>'.$key[1].'</p></a></li>';} ?>
				</ul>
			</div>

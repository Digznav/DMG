...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<div id="container">
			<?php
			$idHotel = $_GET['id'];
			$urlEng = "../en/mobile/Hotel?id=".$idHotel; $actMenu = 'Donde_hospedarse'; include("libs/header.php");
			...
			<div class="cont onlyText clearfix">
				<h2 class="sectionTitle showText" data-hotel="<?php echo $resulthotel[0]; ?>"><?php echo $resulthotel[1]; ?></h2>
				<aside class="extraInfo clearfix">
					<div class="instLogo"><?php echo '<img src="../'.$resulthotel[4].'">'; ?></div>
					<table class="availableTable">
					<?php echo '<tr><td class="col1">Habitaciones</td><td class="col2">'.$resulthotel[6].'</td></tr>';
					$sqlHotelHab = mysql_query("SELECT * FROM habitaciones WHERE id_hotel=$idHotel")or die(mysql_error());
				...
				<div class="m-carousel m-fluid m-carousel-photos">
					...
					<div class="m-carousel-inner">
						...
						$f = 1;
						while ($resimagenes = mysql_fetch_array($sqlHotelImgs)) {
							if ($f == 1) {
				...
				<div><?php echo $resulthotel[2]; ?></div>
			</div>
			<?php include("libs/reservation2.php"); ?>
		</div>

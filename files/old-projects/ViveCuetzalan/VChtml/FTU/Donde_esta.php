...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<div id="container">
			<?php $urlEng = "en/Where_is_it"; $actMenu = 'Donde_esta'; include("libs/header.php");
			include("libs/reservation.php"); ?>

			<div class="cont imageText mapCont clearfix">
				<div class="textCont">
					<h2 class="sectionTitle">Dónde está Cuetzalan</h2>
					<div id="panel">
		...
		<script type="text/javascript">
			...
			(function($) {
				for (var i=1; i<=7; i++) {
					iniBackgrounds.push({ src: 'imgs/dondeesta/img'+i+'.jpg', fade: 1000 });
				};

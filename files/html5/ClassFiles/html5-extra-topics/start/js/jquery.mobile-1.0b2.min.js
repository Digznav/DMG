...
(function (a, d) {
    ...
    a.widget = function (b, c, d) {
        ...
        a[h][b].prototype = a.extend(!0, c, {namespace : h, widgetName : b, widgetEventPrefix : a[h][b].prototype.widgetEventPrefix || b, widgetBaseClass : i}, d);
    ...
    a.Widget.prototype = {widgetName : "widget", widgetEventPrefix : "",
        options : {disabled : !1}, _createWidget : function (b, c) {
...
(function (a, d) {
    a.widget("mobile.widget", {_getCreateOptions : function () {
...
(function (a, d) {
    ...
    a.extend(a.support, {orientation : "orientation"in
        ...
        f.length ? e = f.attr("href") : f = d = a("<base>", {href : c}).appendTo("head");
...
(function (a, d, c, b) {
    ...
    function e(b) {
        for (var c = {}, f, d; b;) {
            f = a.data(b, n);
            for (d in f)if (f[d])c[d] = c.hasVirtualBinding = !0;
            b = b.parentNode
        }
        return c
    }
    ...
    function p(a) {
        if (!r) {
            ...
            var b = e(a.target), c;
            h("vmouseup", a, b);
            !s && h("vclick", a, b) && (c = f(a).changedTouches[0], A.push({touchID : B,
                x : c.clientX, y : c.clientY}), w = !0);
            h("vmouseout", a, b);
            s = !1;
            g()
        }
        ...
        b.bind(e, function (f) {
            function d(b) {
                if (p) {
                    ...
                    o = {time : (new Date).getTime(), coords : [c.pageX, c.pageY]};
            ...
            var e = f.originalEvent.touches ?
                f.originalEvent.touches[0] : f, p = {time : (new Date).getTime(), coords : [e.pageX, e.pageY], origin : a(f.target)}, o;
...
(function (a, d, c) {
    ...
    g = function () {
        function g() {
            var c = b(), e = n(o);
            if (c !== o)q(o = c, e), a(d).trigger(f); else if (e !== o)location.href = location.href.replace(/#.*/, "") +
                e;
        ...
        a.browser.msie && !k && function () {
            var c, d;
            h.start = function () {
                if (!c)d = (d = a.fn[f].src) && d + b(), c = a('<iframe tabindex="-1" title="empty"/>').hide().one("load",
                    function () {
                        d || q(b());
                        g()
...
(function (a) {
    a.widget("mobile.page", a.mobile.widget, {options : {theme : "c", domCache : !1}, _create : function () {
        var a = this.element, c = this.options;
        this._trigger("beforeCreate") !== !1 && a.addClass("ui-page ui-body-" + c.theme)
    }})
})(jQuery);
(function (a, d) {
    a.extend(a.mobile, {ns : "", subPageUrlKey : "ui-page", activePageClass : "ui-page-active", activeBtnClass : "ui-btn-active", ajaxEnabled : !0, hashListeningEnabled : !0, defaultPageTransition : "slide", minScrollBack : screen.height / 2, defaultDialogTransition : "pop", loadingMessage : "loading", pageLoadErrorMessage : "Error Loading Page", autoInitializePage : !0, gradeA : function () {
        return a.support.mediaquery || a.mobile.browser.ie && a.mobile.browser.ie >= 7
    }, keyCode : {ALT : 18, BACKSPACE : 8, CAPS_LOCK : 20, COMMA : 188, COMMAND : 91, COMMAND_LEFT : 91,
...
(function (a, d) {
    ...
    function e(b, d, f, e) {
        ...
        d && (d.height(i + h).jqmData("lastScroll", h).jqmData("lastClicked", q), d.data("page")._trigger("beforehide", null, {nextPage : b}));
        b.height(i + j).data("page")._trigger("beforeshow", null, {prevPage : d || a("")});
        ...
        f.done(function () {
            ...
            d && d.height("").data("page")._trigger("hide",
                null, {nextPage : b});
            b.data("page")._trigger("show", null, {prevPage : d || a("")})
        });
        return f
    }
    ...
    var m = a(window), p = a("html"), o = a("head"), j = {urlParseRE : /^(((([^:\/#\?]+:)?(?:\/\/((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?]+)(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/, parseUrl : function (b) {
        if (a.type(b) === "object")return b;
        var b = j.urlParseRE.exec(b), c;
        b && (c = {href : b[0] || "", hrefNoHash : b[1] || "", hrefNoSearch : b[2] || "", domain : b[3] || "", protocol : b[4] || "", authority : b[5] ||
            "", username : b[7] || "", password : b[8] || "", host : b[9] || "", hostname : b[10] || "", port : b[11] || "", pathname : b[12] || "", directory : b[13] || "", filename : b[14] || "", search : b[15] || "", hash : b[16] || ""});
        return c || {}
        ...
        var b = j.parseUrl(a);
        if (j.isEmbeddedPage(b))return b.hash.split(v)[0].replace(/^#/, ""); else if (j.isSameDomain(b, s))return b.hrefNoHash.replace(s.domain, "");
        return a
    }, get : function (a) {
        ...
        set : function (a) {
            ...
            if (a.protocol !== "")return a.hash && (a.hrefNoHash === u.hrefNoHash || A && a.hrefNoHash ===
                s.hrefNoHash);
            return/^#/.test(a.href)
        }}, q = null, n = {stack : [], activeIndex : 0, getActive : function () {
        ...
        n.stack.push({url : a, transition : b, title : c, pageUrl : d});
    ...
    a.mobile.transitionHandlers = {none : a.mobile.defaultTransitionHandler};
    ...
    a.mobile.loadPage = function (b, c) {
        ...
        !a.mobile.allowCrossDomainPages && !j.isSameDomain(u, p) ? f.reject(p, c) : a.ajax({url : n, type : e.type, data : e.data, dataType : "html", success : function (d) {
            var l =
            ...
            w && w.set(j.get());
            e.showLoadMsg && (clearTimeout(k), a.mobile.hidePageLoadingMsg(), a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>" + a.mobile.pageLoadErrorMessage + "</h1></div>").css({display : "block", opacity : 0.96, top : m.scrollTop() + 100}).appendTo(e.pageContainer).delay(800).fadeOut(400,
                function () {
                    a(this).remove()
                }));
            f.reject(p, c)
    ...
    a.mobile.changePage = function (c, g) {
        if (typeof g !== "object") {
            var h = null;
            if (typeof c === "object" && c.url && c.type)h = {type : c.type, data : c.data, forcePageLoad : !0}, c = c.url;
        ...
        if (t)z.unshift(arguments); else {
            ...
            if (typeof c == "string")a.mobile.loadPage(c, m).done(
                ...
                if (h && h[0] === c[0])t = !1, s.trigger("changepage"); else {
                    i(c, m.role);
                    m.fromHashChange && n.directHashChange({currentUrl : o, isBack : function () {
                        y = -1
                    }, isForward : function () {
                        y = 1
                    }});
    ...
    a.mobile.changePage.defaults = {transition : d, reverse : !1, changeHash : !0,
        fromHashChange : !1, role : d, duplicateCachedPage : d, pageContainer : d, showLoadMsg : !0};
    a.mobile._registerInternalEvents = function () {
        a("form").live("submit", function (b) {
            ...
            if (a.mobile.ajaxEnabled && !c.is(":jqmData(ajax='false')")) {
                ...
                !j.isExternal(e) && !f && (a.mobile.changePage(e, {type : d && d.length && d.toLowerCase() || "get", data : c.serialize(), transition : c.jqmData("transition"),
                    direction : c.jqmData("direction"), reloadPage : !0}), b.preventDefault())
            }
        });
        ...
        a(document).bind("click", function (c) {
            ...
            if (f) {
                ...
                if (a.mobile.ajaxEnabled) {
                    ...
                    if (f.search("#") != -1)if (f = f.replace(/[^#]*#/, ""))f = j.isPath(f) ? j.makeUrlAbsolute(f, h) : j.makeUrlAbsolute("#" + f, u.hrefNoHash); else {
                        c.preventDefault();
                        return
                    }
                    ...
                    h ? g() : (g = e.jqmData("transition"), h = (h = e.jqmData("direction")) &&
                        h === "reverse" || e.jqmData("back"), e = e.attr("data-" + a.mobile.ns + "rel") || d, a.mobile.changePage(f, {transition : g, reverse : h, role : e}), c.preventDefault())
                } else g()
            }
        });
        ...
        m.bind("hashchange", function () {
            ...
            if (!a.mobile.hashListeningEnabled ||
                n.ignoreNextHashChange)n.ignoreNextHashChange = !1; else {
                if (n.stack.length > 1 && b.indexOf(v) > -1)if (a.mobile.activePage.is(".ui-dialog")) {
                    var f = function () {
                        b = a.mobile.urlHistory.getActive().pageUrl
                    };
                    n.directHashChange({currentUrl : b, isBack : f, isForward : f})
                } else {
                    n.directHashChange({currentUrl : b, isBack : function () {
                        window.history.back()
                    }, isForward : function () {
                ...
                b ? (b = typeof b === "string" && !j.isPath(b) ? "#" + b : b, a.mobile.changePage(b, {transition : c, changeHash : !1, fromHashChange : !0})) :
                    a.mobile.changePage(a.mobile.firstPage, {transition : c, changeHash : !1, fromHashChange : !0})
            }
        });
...
(function (a) {
    a.mobile.page.prototype.options.degradeInputs = {color : !1, date : !1, datetime : !1, "datetime-local" : !1, email : !1, month : !1, number : !1, range : "number", search : !0, tel : !1, time : !1, url : !1, week : !1};
        ...
        a(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')",
            this).each(function () {
                ...
                if (f === "header" || f === "footer") {
                    ...
                    b.children("h1, h2, h3, h4, h5, h6").addClass("ui-title").attr({tabindex : "0", role : "heading", "aria-level" : "1"})
                } else f === "content" && (b.addClass("ui-body-" + (e || c || d.contentTheme)), b.attr("role", "main"))
            })
    })
})(jQuery);
(function (a) {
    a.widget("mobile.collapsible", a.mobile.widget, {options : {expandCueText : " click to expand contents", collapseCueText : " click to collapse contents", collapsed : !1, heading : ">:header,>legend", theme : null, iconTheme : "d", initSelector : ":jqmData(role='collapsible')"}, _create : function () {
...
(function (a) {
    a.fn.grid = function (d) {
        return this.each(function () {
            var c = a(this), b = a.extend({grid : null}, d), f = c.children(), e = {solo : 1, a : 2, b : 3, c : 4, d : 5}, b = b.grid;
...
(function (a, d) {
    a.widget("mobile.navbar", a.mobile.widget, {options : {iconpos : "top", grid : null, initSelector : ":jqmData(role='navbar')"}, _create : function () {
        ...
        c.addClass("ui-navbar").attr("role", "navigation").find("ul").grid({grid : this.options.grid});
        f || c.addClass("ui-navbar-noicons");
        b.buttonMarkup({corners : !1, shadow : !1, iconpos : f});
...
(function (a) {
    var d = {};
    a.widget("mobile.listview", a.mobile.widget, {options : {theme : "c", countTheme : "c", headerTheme : "b", dividerTheme : "b", splitIcon : "arrow-r", splitTheme : "b", inset : !1, initSelector : ":jqmData(role='listview')"}, _create : function () {
        var a = this;
        ...
        b.find(".ui-li-count").addClass("ui-btn-up-" + (c.jqmData("counttheme") || this.options.countTheme) +
            " ui-btn-corner-all").end().find("h1, h2, h3, h4, h5, h6").addClass("ui-li-heading").end().find("p, dl").addClass("ui-li-desc").end().find(">img:eq(0), .ui-link-inherit>img:eq(0)").addClass("ui-li-thumb").each(
            function () {
        ...
        for (var q = 0, n = i.length; q < n; q++) {
            l = i.eq(q);
            m = "ui-li";
            if (c || !l.hasClass("ui-li"))p = l.jqmData("theme") || b.theme, o = l.children("a"), o.length ? (j = l.jqmData("icon"), l.buttonMarkup({wrapperEls : "div", shadow : !1, corners : !1, iconpos : "right", icon : o.length > 1 || j === !1 ? !1 : j || "arrow-r", theme : p}), o.first().addClass("ui-link-inherit"), o.length > 1 && (m += " ui-li-has-alt", o = o.last(), j = g || o.jqmData("theme") || b.splitTheme, o.appendTo(l).attr("title", o.text()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow : !1, corners : !1,
                theme : p, icon : !1, iconpos : !1}).find(".ui-btn-inner").append(a("<span />").buttonMarkup({shadow : !0, corners : !0, theme : j, iconpos : "notext", icon : h || o.jqmData("icon") || b.splitIcon})))) : l.jqmData("role") === "list-divider" ? (m += " ui-li-divider ui-btn ui-bar-" + e, l.attr("role", "heading"), k && (k = 1)) : m += " ui-li-static ui-body-" + p;
        ...
        g = g || ++d[e];
        a(c.find("li>ul, li>ol").toArray().reverse()).each(
            function (b) {
...
(function (a) {
    ...
    a(":jqmData(role='listview')").live("listviewcreate", function () {
        ...
        if (c.options.filter) {
            ...
            a("<input>", {placeholder : c.options.filterPlaceholder}).attr("data-" + a.mobile.ns + "type", "search").jqmData("lastval",
                "").bind("keyup change",
                function () {
...
(function (a, d) {
    a.widget("mobile.checkboxradio", a.mobile.widget, {options : {theme : null, initSelector : "input[type='checkbox'],input[type='radio']"}, _create : function () {
        ...
        if (!(e !== "checkbox" && e !== "radio")) {
            a.extend(this, {label : f, inputtype : e, checkedClass : "ui-" + g + (i ? "" : " " + a.mobile.activeBtnClass),
            ...
            f.buttonMarkup({theme : this.options.theme, icon : i, shadow : !1});
            b.add(f).wrapAll("<div class='ui-" + e + "'></div>");
            f.bind({vmouseover : function () {
...
(function (a) {
    a.widget("mobile.button", a.mobile.widget, {options : {theme : null, icon : null, iconpos : null, inline : null, corners : !0, shadow : !0, iconshadow : !0, initSelector : "button, [type='button'], [type='submit'], [type='reset'], [type='image']"}, _create : function () {
        ...
        this.button = a("<div></div>").text(d.text() || d.val()).buttonMarkup({theme : c.theme, icon : c.icon, iconpos : c.iconpos, inline : c.inline, corners : c.corners, shadow : c.shadow, iconshadow : c.iconshadow}).insertBefore(d).append(d.addClass("ui-btn-hidden"));
        c = d.attr("type");
        c !== "button" && c !== "reset" && d.bind("vclick", function () {
            var b = a("<input>", {type : "hidden", name : d.attr("name"), value : d.attr("value")}).insertBefore(d);
...
(function (a, d) {
    a.widget("mobile.slider", a.mobile.widget, {options : {theme : null, trackTheme : null, disabled : !1, initSelector : "input[type='range'], :jqmData(type='range'), :jqmData(role='slider')"}, _create : function () {
        ...
        }, m = h == "input" ? parseFloat(b.attr("min")) : 0, p = h == "input" ? parseFloat(b.attr("max")) : b.find("option").length - 1, o = window.parseFloat(b.attr("step") || 1), j = a("<div class='ui-slider " + f + " ui-btn-down-" + g + " ui-btn-corner-all' role='application'></div>"), q = a("<a href='#' class='ui-slider-handle'></a>").appendTo(j).buttonMarkup({corners : !0, theme : e, shadow : !0}).attr({role : "slider",
            "aria-valuemin" : m, "aria-valuemax" : p, "aria-valuenow" : l(), "aria-valuetext" : l(), title : l(), "aria-labelledby" : k});
        a.extend(this, {slider : j, handle : q, dragging : !1, beforeStart : null});
        ...
        b.addClass(h === "input" ? "ui-slider-input" : "ui-slider-switch").change(
            function () {
                c.refresh(l(), !0)
            }).keyup(
            function () {
        ...
        j.insertAfter(b);
        this.handle.bind("vmousedown",
            function () {
                a(this).focus()
            }).bind("vclick", !1);
        this.handle.bind("keydown",
            function (b) {
                var d = l();
        ...
        if (!this.options.disabled) {
            ...
            if (!isNaN(a)) {
                ...
                this.handle.attr({"aria-valuenow" : g === "input" ? k : e.find("option").eq(k).attr("value"), "aria-valuetext" : g === "input" ? k : e.find("option").eq(k).text(), title : k});
...
(function (a) {
    a.widget("mobile.textinput", a.mobile.widget, {options : {theme : null, initSelector : "input[type='text'], input[type='search'], :jqmData(type='search'), input[type='number'], :jqmData(type='number'), input[type='password'], input[type='email'], input[type='url'], input[type='tel'], textarea"}, _create : function () {
        ...
        d.is("[type='search'],:jqmData(type='search')") ? (f = d.wrap("<div class='ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield" + b + "'></div>").parent(), e = a("<a href='#' class='ui-input-clear' title='clear text'>clear text</a>").tap(
            function (a) {
                d.val("").focus();
                d.trigger("change");
                e.addClass("ui-input-clear-hidden");
                a.preventDefault()
            }).appendTo(f).buttonMarkup({icon : "delete", iconpos : "notext", corners : !0, shadow : !0}), c = function () {
        ...
        if (d.is("textarea")) {
            var g = function () {
                ...
                d[0].clientHeight < a && d.css({height : a +
                    15})
            }, h;
            d.keyup(function () {
                clearTimeout(h);
...
(function (a) {
    a.widget("mobile.selectmenu", a.mobile.widget, {options : {theme : null, disabled : !1, icon : "arrow-d", iconpos : "right", inline : null, corners : !0, shadow : !0, iconshadow : !0, menuPageTheme : "b", overlayTheme : "a", hidePlaceholderMenuItems : !0, closeText : "Close", nativeMenu : !0, initSelector : "select:not(:jqmData(role='slider'))"}, _create : function () {
        var d = this, c = this.options, b = this.element.wrap("<div class='ui-select'>"), f = b.attr("id"), e = a("label[for='" + f + "']").addClass("ui-select"), g = b[0].selectedIndex == -1 ? 0 : b[0].selectedIndex,
            h = (d.options.nativeMenu ? a("<div/>") : a("<a>", {href : "#", role : "button", id : l, "aria-haspopup" : "true", "aria-owns" : m})).text(a(b[0].options.item(g)).text()).insertBefore(b).buttonMarkup({theme : c.theme, icon : c.icon, iconpos : c.iconpos, inline : c.inline, corners : c.corners, shadow : c.shadow, iconshadow : c.iconshadow}), i = d.isMultiple = b[0].multiple;
        ...
        if (!c.nativeMenu) {
            ...
            o.find(".ui-header a");
            var q = a("<div>", {"class" : "ui-selectmenu-screen ui-screen-hidden"}).appendTo(p), n = a("<div>", {"class" : "ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-" +
                c.overlayTheme + " " + a.mobile.defaultDialogTransition}).insertAfter(q), x = a("<ul>", {"class" : "ui-selectmenu-list", id : m, role : "listbox", "aria-labelledby" : l}).attr("data-" + a.mobile.ns + "theme", g).appendTo(n), z = a("<div>", {"class" : "ui-header ui-bar-" + g}).prependTo(n), t = a("<h1>", {"class" : "ui-title"}).appendTo(z), v = a("<a>", {text : c.closeText, href : "#", "class" : "ui-btn-left"}).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(z).buttonMarkup()
        }
        ...
        a.extend(d, {select : b, optionElems : k, selectID : f, label : e, buttonId : l, menuId : m, thisPage : p, button : h, menuPage : o, menuPageContent : j, screen : q, listbox : n, list : x, menuType : void 0, header : z, headerClose : v, headerTitle : t, placeholder : ""});
        c.nativeMenu ? b.appendTo(h).bind("vmousedown",
            function () {
        ...
        }), x.attr("role", "listbox").delegate(".ui-li>a", "focusin",
            function () {
                a(this).attr("tabindex", "0")
            }).delegate(".ui-li>a", "focusout",
            function () {
        ...
        var c = this, b = this.element, f = this.isMultiple, e = this.optionElems = b.find("option"), g = e.filter(":selected"), h = g.map(
            function () {
                return e.index(this)
            }).get();
        ...
        if (!this.options.disabled && !this.options.nativeMenu) {
            ...
            if (b > h - 80 || !a.support.scrollTop) {
                ...
                c.listbox.append(c.list).removeClass("ui-selectmenu-hidden").css({top : b, left : p}).addClass("in");
                d();
                c.isOpen = !0
            }
        }
...
(function (a) {
    ...
    {corners : !0, shadow : !0, iconshadow : !0, wrapperEls : "span"};
    var c = function () {
        a(document).bind({vmousedown : function (b) {
            var b = d(b.target), c;
...
(function (a) {
    a.fn.controlgroup = function (d) {
        return this.each(function () {
            ...
            var b = a(this), f = a.extend({direction : b.jqmData("type") || "vertical", shadow : !1, excludeInvisible : !0}, d), e = b.find(">legend"), g = f.direction == "horizontal" ? ["ui-corner-left", "ui-corner-right"] : ["ui-corner-top", "ui-corner-bottom"];
    ...
    a(document).bind("pagecreate create", function (d) {
        a(":jqmData(role='controlgroup')", d.target).controlgroup({excludeInvisible : !1})
    })
})(jQuery);
(function (a) {
    a(document).bind("pagecreate create", function (d) {
    ...
    a.mobile.fixedToolbars = function () {
        ...
        if (a.support.scrollTop) {
            ...
            a(function () {
                ...
                (b.scrollTop() === 0 ? d : b).bind("scrollstart",
                    function () {
                        l = !0;
                        k === null && (k = h);
                        var b = k == "overlay";
            ...
            return{show : function (c, d) {
                ...
                return(a.mobile.activePage ? a.mobile.activePage : a(".ui-page-active")).children(".ui-header-fixed:first, .ui-footer-fixed:not(.ui-footer-duplicate):last").each(function () {
                    ...
                    if (d < 0 || c.is(".ui-header-fixed") && d !== 0)b ? c.css("top", 0) : c.css("top") !== "auto" && parseFloat(c.css("top")) !== 0 && c.animationComplete(
                        function () {
...
(function (a, d) {
    ...
    if (a.mobile.gradeA()) {
        ...
        a.extend(a.mobile, {showPageLoadingMsg : function () {
            if (a.mobile.loadingMessage) {
                var b = a("." + a.mobile.activeBtnClass).first();
                f.find("h1").text(a.mobile.loadingMessage).end().appendTo(a.mobile.pageContainer).css({top : a.support.scrollTop &&
            ...
            a.mobile.showPageLoadingMsg();
            !a.mobile.hashListeningEnabled || !a.mobile.path.stripHash(location.hash) ? a.mobile.changePage(a.mobile.firstPage, {transition : "none", reverse : !0, changeHash : !1, fromHashChange : !0}) : b.trigger("hashchange", [!0])
        }});
